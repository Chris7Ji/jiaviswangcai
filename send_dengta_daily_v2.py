...
# 读取HTML内容
with open('/Users/jiyingguo/.openclaw/workspace/dengta_project_daily_v2_20260319.html', 'r', encoding='utf-8') as f:
    html_content = f.read()
...
msg['Subject'] = "🎯 [03月19日] 高校分队灯塔项目每日动态：广东省AI OPC行动方案发布，中科大光钟刷新人类计时极限"
...
try:
    ...
    print("📊 情报模块: 5个")
    print("🎯 重点动态: 深圳河套学院3条 + 中科大8条")
    print("⏰ 发送时间: 06:45（已调整）")
    print("📅 监测周期: 过去3天")
