...
SKILLS=(prettier babel rollup vite gradle maven make cmake digitalocean cloudflare)
DELAY=30
LOG_FILE="/Users/jiyingguo/.openclaw/workspace/logs/day4_$(date '+%Y%m%d_%H%M%S').log"
