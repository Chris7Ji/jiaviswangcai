...
SKILLS=(kubernetes azure gcp signal image-processing todo nodejs netlify teams anthropic)
DELAY=30
LOG_FILE="/Users/jiyingguo/.openclaw/workspace/logs/day2_$(date '+%Y%m%d_%H%M%S').log"
