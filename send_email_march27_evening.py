...
<body>
    ...
    <div class="note">
        <strong>说明：</strong>本简报为晚间补充版，新闻来源与上午版相同（53ai.com 3月26-27日更新）。如需查看最新新闻，请关注明日早间版。
    </div>
    ...
    <div class="section">
        ...
        <div class="news-item">
            ...
            <div class="news-summary">GitHub宣布自2026年4月24日起，Copilot Free、Pro和Pro+个人及小团队用户的交互数据（含输入、输出、代码片段、上下文等）默认用于训练AI模型。老用户若曾设置不允许收集则不受影响，新用户或默认设置用户需注意退出选项。</div>
