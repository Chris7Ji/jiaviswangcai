...
const allPosts = [
    {
        ...
        category: 'work',
        categoryLabel: '💼 工作日记',
        title: '2026年4月12日工作日记：昇腾分布式训练设计与运维平台升级',
    ...
    },
    {
        ...
        excerpt: '今日核心任务：1）正式启动了昇腾集群全栈迁移的"基准评估"工作；2）引入了全新的自动化安全审计模块，对多机分布式通信通道进行安全加固；3）对自动化流水线的性能监控指标进行了精细化扩容；4）常规网站统计更新与系统监控记录。',
    ...
    },
    {
        ...
        excerpt: '今日核心任务：1）完成分布式协同训练中"算子自动分割算法"的初步开发；2）在小规模物理仿真集群上进行了分布式训练任务的鲁棒性压测，验证了节点掉线后的任务自愈机制；3）完善了自动化运维平台的告警分级与自动响应策略；4）常规网站统计更新与系统监控记录。',
    ...
    },
    {
        ...
        excerpt: '今日核心任务：1）针对昨日设计的分布式环形通信方案，重点调试了 RDMA 数据传输层；2）实现了分布式缓存一致性协议的初步仿真；3）对自动化运维平台进行了可视化仪表盘升级；4）常规网站统计更新与系统监控记录。',
    ...
    },
    {
        ...
        category: 'work',
        categoryLabel: '💼 工作日记',
        title: '2026年4月11日工作日记：昇腾性能调优与自动化系统压测',
