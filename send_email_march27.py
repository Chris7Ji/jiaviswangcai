...
<head>
    <meta charset="UTF-8">
    <title>高校分队 AI 新闻每日简报 - 2026年3月27日</title>
    <style>
...
<body>
    ...
    <div class="section">
        ...
        <div class="news-item">
            ...
            <div class="news-summary">林俊旸离职阿里千问后首次发声，复盘千问合并thinking与instruct模式的弯路，指出AI未来方向为从推理模型转向智能体式思维，强调需在思考与行动间切换、动态规划工具调用等，认为未来竞争力来自环境设计、harness工程及系统训练。</div>
        ...
        <div class="news-item">
            ...
            <div class="news-summary">GitHub宣布自2026年4月24日起，Copilot Free、Pro和Pro+个人及小团队用户的交互数据（含输入、输出、代码片段、上下文等）默认用于训练AI模型。旧用户若曾设置不允许收集则不受影响，新用户或默认设置用户需注意退出选项。</div>
        ...
        <div class="news-item">
            ...
            <div class="news-summary">harness engineering成为继prompt engineering、context engineering之后的新热点，被视为模型智能提升的关键方向。harness类比马具，是驾驭模型的外围系统，随着模型能力成熟，系统层面（如运行环境、工具调用等）成为瓶颈，DeepMind等团队已开始实践。</div>
        ...
        <div class="news-item">
            ...
            <div class="news-summary">Google DeepMind推出的浏览器可借助Gemini 3.1 Flash-Lite实时生成网站，用户输入查询后快速生成包含导航和内容的网页，展示了大模型在实时响应与代码生成上的能力，挑战传统GUI模式。</div>
    ...
    <div class="section">
        ...
        <div class="news-item">
            ...
            <div class="news-summary">Claude Code使用成本高，作者分享5招降低token成本：切换模型（普通任务用sonnet，特殊任务用opus）、控制上下文在60%以下、优化规则与技能使用、用依赖图工具减少文件读取、使用官方Max订阅，实测节省一半token。</div>
            <a class="news-link" href="https://www.53ai.com/news/LargeLanguageModel/2026032649736.html" target="_blank">查看原文</a>
        </div>
        
        <div class="news-item">
            <div class="news-title">治愈Cursor AI编程的"幻觉"？用它就够了！</div>
            <div class="news-meta">来源：53AI | 发布时间：2026-03-26 17:56</div>
            <div class="news-summary">AI编程实践中因缺乏标准化约束导致生成逻辑碎片化，天玑前端团队通过规格驱动开发（SDD）结合OpenSpec、Spec Kit、BMAD等工具，自研适配Cursor的AI研发流（Specflow），解决大模型生成代码的"幻觉"问题。</div>
        ...
        <div class="news-item">
            ...
            <div class="news-summary">Anthropic复盘Claude Code开发中智能体系统设计的核心，重点探讨工具设计的重要性及相关尝试，如"AskUserQuestion"工具的设计思路。这为AI智能体开发提供了官方最佳实践参考。</div>
        ...
        <div class="news-item">
            ...
            <div class="news-summary">Claude Code推出auto mode，通过AI分类器替代人工审批，解决安全审批疲劳及操作越界问题，利用闭源大模型Claude的能力实现安全自动审查，避免过度主动行为。</div>
    ...
    <div class="section">
        ...
        <div class="news-item">
            <div class="news-title">Google极限压缩算法：内存砍6倍，速度快8倍，精度零损失<span class="badge-hot">今日重要</span></div>
            <div class="news-meta">来源：53AI | 发布时间：2026-03-26 12:30</div>
            <div class="news-summary">Google Research发布TurboQuant压缩算法，优化大模型KV Cache压缩，将内存占用降6倍、推理速度提升8倍且精度无损失，通过PolarQuant和QJL算法解决传统量化校准常数开销问题。</div>
            <a class="news-link" href="https://www.53ai.com/news/LargeLanguageModel/2026032634675.html" target="_blank">查看原文</a>
        </div>
        
        <div class="news-item">
            <div class="news-title">Claude团队深夜祭出"自动模式"！里程碑式进化</div>
            <div class="news-meta">来源：53AI | 发布时间：2026-03-26 07:50</div>
            <div class="news-summary">Claude团队推出Claude Code的"自动模式"，可自动处理文件写入、bash命令等编程任务，无需用户逐次批准，提升编程效率，同时内置安全机制保障操作安全，是闭源大模型Claude的里程碑式能力进化。</div>
    ...
    <div class="section">
        ...
        <div class="news-item">
            ...
            <div class="news-meta">来源：53AI | 发布时间：2026-03-27 04:21</div>
            <div class="news-summary">前阿里千问核心成员林俊旸指出AI未来方向：从推理模型转向智能体式思维，强调在思考与行动间动态切换、规划工具调用。认为未来竞争力来自环境设计、harness工程及系统训练。</div>
            <a class="news-link" href="https://www.53ai.com/news/LargeLanguageModel/2026032704173.html" target="_blank">查看原文</a>
        </div>
        
        <div class="news-item">
            <div class="news-title">如何设计Harness工程，实现长时间自动开发应用</div>
            <div class="news-meta">来源：53AI | 发布时间：2026-03-25 20:28</div>
            <div class="news-summary">Anthropic工程团队探索设计多AI协同的Harness工程架构，解决AI长时间独立完成完整应用开发的问题，涉及生成与评估AI协作及上下文重置等方法，属于大模型前沿技术应用。</div>
            <a class="news-link" href="https://www.53ai.com/news/LargeLanguageModel/2026032510923.html" target="_blank">查看原文</a>
        </div>
    </div>
    ...
    <div class="section">
        ...
        <div class="news-item">
            ...
            <div class="news-summary">天猫团队构建三层AI Coding度量体系（质量、链路、结果指标），用数据证明AI Coding的团队价值，解决"感觉有效"问题，明确能力边界与问题诊断，推动AI从工具升级为团队知识治理基础设施。</div>
    ...
    <div class="footer">
        ...
        <p>生成时间：2026年3月27日 06:55 (北京时间)</p>
    </div>
</body>
</html>"""
...
def send_email(to_email, subject, html_body):
    ...
    msg["From"] = EMAIL
    msg["To"] = to_email
    plain_text = "高校分队 AI 新闻每日简报 2026年3月27日\n\n请使用HTML格式查看完整内容。"
...
subject = "[2026-03-27] 高校分队 AI 新闻每日简报"
sent_count = 0
failed = []
for to in TO_EMAILS:
    try:
