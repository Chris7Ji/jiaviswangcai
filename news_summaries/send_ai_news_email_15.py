...
def send_ai_news_email_15():
    ...
    # 邮件主题
    subject = f'[{date_str}] 高校分队- AI 新闻每日简报'
...
"""
    ...
    try:
        ...
        # 发送邮件
        print(f"正在发送邮件到 {len(receivers)} 位收件人...")
        server.sendmail(sender, receivers, message.as_string())
        server.quit()
        
        print(f"邮件发送成功！共发送给 {len(receivers)} 位收件人")
        return True
...
if __name__ == "__main__":
    print("=" * 60)
    print("开始发送高校分队AI新闻每日简报...")
    print("=" * 60)
    success = send_ai_news_email_15()
